				...
				<div class="alert alert-info">
							<strong>Datos Credito</strong>
							   ...
							   <div class="control-group ">
								...
								<div class="controls">
								  <input class="input-xlarge " id="credito" name="credito" type="number" value="<?php echo $credito?>">
								</div>
							  </div>
							  ...
							  <div class="control-group ">
								...
								<div class="controls">
								  <input class="input-xlarge" id="total_ultimo" name="total_ultimo" type="number" value="<?php echo $total_ultimo?>">
								</div>
							  </div>
							  ...
							  <div class="control-group">
							   ...
							   <div class="control-group ">
								...
								<div class="controls">
								  <input class="input-xlarge " id="saldo" name="saldo" type="number" value="<?php echo $saldo?>">
								</div>
							  </div>
