...
<form class="form-horizontal" action="/functions/cart.php">
				<fieldset>
                                ...
                                <input type="hidden" name="codigo_inventario" value="60056002">
                    		...
                    		<div class="control-group ">
								<label class="control-label" for="producto"><font color=black>Codigo Andrea</label>
								<div class="controls">
							  ...
							  <div class="control-group">
								<label class="control-label" >Talla</font></label>
								<div class="controls">
