...
<pre style="font: 4px/2px monospace;color:#4EF84E;">                                                                                                                                                              
								...
								$total_iva_contado=$total_contado*.16;
									...
									if ($promociones)
									{
										...
										echo "<tr><td></td><td style='text-align:right'>&nbsp;<font size=+1>Promo BUEN FIN</font></td>
											<td style='text-align:right;text-align:right;color:white;border-bottom:1px solid black;'>
											<font size=+2><b>- ".dinero($promo)."</b></font>&nbsp;&nbsp;</td></tr>";
									
										echo "<tr><td></td><td style='text-align:right'>&nbsp;<font size=+1>Ud. Pagar&aacute;</font></td>
											<td style='text-align:right;text-align:right;color:yellow;border:1px solid black;'>
