...
if ($_SESSION['display']=='dev'){ echo "<center> <h2>Tiendas Alberto</h2>          </center>";}
if ($_SESSION['display']=='pos' && $_SESSION['cart']){ echo "<center> <h2>Tiendas Alberto</h2>          </center>";}
			...
			echo "Devolucion";
						...
						// list( $faturadet_id,$producto,$precio_contado,$iva_contado,$precio_credito,$iva_credito,$codigo,$color,$talla,$sku  ) = $database->get_row( $query );
										...
										echo "<tr><td style='border-top:1px dotted #4EF84E;'> * &nbsp </td> 
											...
											if ($cliente_id)
                                                echo dinero($item[$n]['precio_credito']+($item[$n]['precio_credito']*.16));
                                            else
                                                 if ($item[$n]['descuento'])
                            {
...
<br><br><br><br><Br><br>
                   <center>  <img width=400 src=/img/logo-tiendas-alberto.jpg ></center>
							...
							else
							{
								...
								$total_iva_contado=$total_contado*.16;
									...
									echo "<tr><td></td><td style='text-align:right'>&nbsp;<font size=+2>Total</font></td>
											<td width=180 style='text-align:right;text-align:right;background:white;color:black;border:2px solid;'>
											<font size=+2><b>$ ".dinero($total_contado)."</b></font></td></tr>";
									...
									if ($promociones)
									{
										...
										echo "<tr><td></td><td style='text-align:right'>&nbsp;<font size=+1>$promocion</font></td>
											<td style='text-align:right;text-align:right;color:green;border-bottom:1px solid black;'>
											<font size=+2><b>- ".dinero($promo)."</b></font>&nbsp;&nbsp;</td></tr>";
